 ...
 * with its route metrics, the specialty actually served, the specialty
 * originally requested by the caller, the reservation outcome, and whether
 * the fallback path was taken.
 */
public record RecommendationResponse(
        RecommendedHospitalDto hospital,
        RecommendedSpecialtyDto specialty,
        RecommendedSpecialtyDto requestedSpecialty,
        boolean bedReserved,
        boolean fallback,
        Instant timestamp
) {
